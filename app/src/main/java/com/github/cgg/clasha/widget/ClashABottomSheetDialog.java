 ...
 */
public class ClashABottomSheetDialog extends AppCompatDialog {
    ...
    public ClashABottomSheetDialog(@NonNull Context context) {
        this(context, 0);
    }

    public ClashABottomSheetDialog(@NonNull Context context, @StyleRes int theme) {
    ...
    protected ClashABottomSheetDialog(@NonNull Context context, boolean cancelable,
    ...
    private View wrapInBottomSheet(int layoutResId, View view, ViewGroup.LayoutParams params) {
        container = (FrameLayout) View.inflate(getContext(),
                R.layout.echat_design_bottom_sheet_dialog, null);
