...
import com.github.cgg.clasha.utils.Commandline
import com.github.cgg.clasha.utils.Key
import com.github.cgg.clasha.utils.thread
...
class GuardedProcessPool(private val onFatal: suspend (IOException) -> Unit) : CoroutineScope {
    ...
    private inner class Guard(private val cmd: List<String>) {
        ...
        fun start() {
            process = ProcessBuilder(cmd).directory(app.deviceStorage.noBackupFilesDir).start()
        }
