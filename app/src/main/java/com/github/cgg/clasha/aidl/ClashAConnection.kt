...
import com.github.cgg.clasha.bg.ProxyService
import com.github.cgg.clasha.bg.VpnService
 ...
 */
class ClashAConnection(private val handler: Handler = Handler(),
    ...
    interface Callback {
        ...
        fun onServiceConnected(service: IClashAService)
        /**
    ...
    private val serviceCallback = object : IClashAServiceCallback.Stub() {
    ...
    var service: IClashAService? = null

    override fun onServiceConnected(name: ComponentName?, binder: IBinder) {
        this.binder = binder
        if (listenForDeath) binder.linkToDeath(this, 0)
        val service = IClashAService.Stub.asInterface(binder)!!
